...
## Die Karo-Textur (rough-checked-texture-collage.jpg, siehe
## FLOOR_CEILING_TEXTURE_PATH) ist von Haus aus ebenfalls sehr hell - anders
## als die Waende wurde sie bisher NICHT abgedunkelt (nur mit dem oft hellen
## floor_color pro Theme multipliziert). Rueckmeldung "Schachbrett-Textur des
## Bodens dunkler machen" - gleiche Idee/gleicher Mechanismus wie
## WALL_TEXTURE_DARKEN, siehe room_instance.gd::_apply_theme_recursive().
## Betrifft NUR den Boden, nicht die Decke - die nutzt mit ceiling_color eine
## eigene, bereits dunkle Theme-Farbe (siehe _make_ceiling_material()).
const FLOOR_TEXTURE_DARKEN: float = 0.4
...
static func build_all() -> Array[StageTheme]:
	...
	# Rueckmeldung "Raum mehr belichten" - war 0.55.
	dungeon.ambient_energy = 0.80
	...
	# Rueckmeldung "Raum mehr belichten" - war 0.70.
	ice.ambient_energy = 0.95
	...
	# Rueckmeldung "Raum mehr belichten" - war 0.85.
	desert.ambient_energy = 1.10
	...
	# Rueckmeldung "Raum mehr belichten" - war 0.60.
	flesh.ambient_energy = 0.85
	...
	# Rueckmeldung "Raum mehr belichten" - war 0.65.
	neon.ambient_energy = 0.90
