...
## Persistiert: wird gesetzt sobald das Tutorial mindestens einmal
## erfolgreich abgeschlossen wurde. Entsperrt Normal- und Speedrun-Modus
## im Hauptmenue (main_menu.gd::_build_play_screen()).
...
func save_stats() -> void:
	...
	config.set_value("stats", "tutorial_completed", tutorial_completed)
...
func load_stats() -> void:
	...
	tutorial_completed = bool(config.get_value("stats", "tutorial_completed", false))
...
# Tutorial
# ============================================================================
## Wird von win_screen.gd aufgerufen, wenn das Tutorial erfolgreich beendet
## wurde. Setzt das Flag dauerhaft und entsperrt Normal/Speedrun im Hauptmenue.
