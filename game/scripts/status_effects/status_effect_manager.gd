...
##
## "bleed" wird aktiv genutzt (Rostiges Beil, siehe item_behaviours.gd), hat
## aber bewusst KEINE eigene Status*.gd-Klasse wie acid/burn/stun/etc. - die
## Anzeigefarbe dafuer steht als Literal in status_effect_visuals.gd.
## "poison" ist aktuell nirgends im Projekt tatsaechlich ausgeloest (kein
## Item/Gegner ruft apply_status_effect("poison", ...) auf) - bewusst als
## reservierte ID gefuehrt, kein totes Feature.
