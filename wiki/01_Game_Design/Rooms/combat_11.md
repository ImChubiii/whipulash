...
scene_path: "scenes/rooms/combat/room_combat_11.tscn"
...
`resources/rooms/rd_combat_11.tres` → `scenes/rooms/combat/room_combat_11.tscn`

## 🧠 Semantische Verbindungen (Graphify)
- **contains**: [[combat_11]] (Confidence: 1.0)
